...
trigger1= stateno=3000 && anim=3001 && animelemtime(17)<0 && movecontact
trigger2= stateno=3050 && anim=3050 && movecontact
trigger3= stateno=3100 && animelemtime(14)<0 && movecontact
...
trigger8= stateno=52 && (prevstateno=[1000,4999]) && movecontact
...
trigger1= var(59)>=1 && numenemy
trigger1= roundstate=2 && statetype!=A && ctrl && random<100
...
trigger1= ctrl && random<ifelse(p2statetype=A, 250, 50)
...
trigger3= (stateno=1300 || stateno=1400) && movehit && random<75
trigger4= (stateno=[1000,4999]) && numhelper(stateno+5) && var(10)<=6
trigger4= helper(stateno+5),var(3)
...
triggerall= (enemynear,const(size.head.pos.y)<=-40) || (enemynear,statetype=A)
trigger1= stateno=3000 && anim=3001 && animelemtime(13)>=0 && animelemtime(17)<0 && movecontact && random<100
trigger2= stateno=3050 && anim=3050 && hitcount>=7 && movecontact && random<100
trigger3= stateno=3100 && animelemtime(11)>=0 && animelemtime(14)<0 && movecontact && random<100
