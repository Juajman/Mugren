...
;------------------------------------------------------------------
;Lampi e saette di energia
[State -1]
type = ChangeState
value = 39999
triggerall = command = "lampiesaette"
triggerall = power >= 3000
...
trigger4 = stateno = 205 && animelemtime(4) > 0 && animelemtime(7) < 0
trigger5 = stateno = 220 && animelemtime(3) > 0 && animelemtime(5) < 0
trigger6 = stateno = 210 && animelemtime(4) > 0 && animelemtime(7) < 0
trigger7 = stateno = 230 && animelemtime(4) > 0 && animelemtime(7) < 0
trigger8 = stateno = 410 && animelemtime(2) > 0 && animelemtime(4) < 0
trigger9 = stateno = 420 && animelemtime(3) > 0 && animelemtime(5) < 0
trigger10 = stateno = 980 && animelemtime(5) > 0 && animelemtime(7) < 0
...
Triggerall = StateType != A
Triggerall = !var(59)
Triggerall = (P2BodyDist X = (-21-31,21))
