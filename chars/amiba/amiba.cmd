...
[Command];★
name = "63214_b"
command = ~D, DF, F, a+y;F, DF, D, DB, B, b
[Command]
name = "63214xy"
...
[Command];★
name = "うわばら！"
command = ~D,D,x+y;B,DB,D,DF,F,DF,D,DB,B,x
time = 35
...
[Command];★
name = "レッツゴーアミバ！"
command = ~F, a+b;D, DF, F, D, DF, F, D, DF, F,y
time = 40
...
triggerall = command = "AD"
triggerall = var(50) = 2 || var(50) = 3
triggerall = statetype != A
trigger1 = ctrl || stateno = 9905 || stateno = 9906 || stateno = 9915 || stateno = 9916
trigger2 = hitdefattr = SC, NA, SA
trigger2 = movecontact
...
[State -1, sprak];サーキットスパーク
type = ChangeState
value = 1950
triggerall = var(59) = 0
triggerall = var(41) = 0
triggerall = command = "bloodheat"  || command = "c"
triggerall = statetype = S || statetype = C
...
triggerall = fvar(12) = 0.1;power >= 9000
triggerall = command = "y"
triggerall = command = "z";"hokuto";236xy";63214xy"
triggerall = statetype != A
trigger1 = ctrl = 1 || stateno = 9905 || stateno = 9906 || stateno = 9915 || stateno = 9916
trigger2 = hitdefattr = SC, NA
trigger2 = movecontact
trigger3 = stateno = 9677
[State -1]
type = ChangeState
value = 1050;1206
triggerall = var(41) = 3
triggerall = power >= 1000
triggerall = command = "236xy";63214xy"
triggerall = statetype != A
trigger1 = ctrl = 1 || stateno = 9905 || stateno = 9906 || stateno = 9915 || stateno = 9916
trigger2 = hitdefattr = SC, NA, SA
trigger2 = movecontact
...
type = ChangeState
value = 1001
triggerall = ifelse(enemy,name = "JAGI",enemy,Numhelper(1001) = 0, 1)
triggerall = var(59) = 0
triggerall = var(41) = 2
...
trigger7 = stateno = 1181
trigger7 = movecontact
trigger8 = stateno = 1051 || stateno = 1053
...
trigger1 = ctrl
trigger2 = movecontact && var(59) = 0
trigger2 = stateno=8200 || stateno=8210|| stateno=8225 || stateno=8221 || stateno=8211 || stateno=8226 || stateno=8228 || stateno=8202 || stateno=8203
trigger3 = stateno=8400 || stateno=8410 || stateno=8420 || stateno=8430
trigger3 = movecontact && var(59) = 0
trigger4 = stateno = 1001 || stateno = 1003;[1000,1005]
trigger4 = ifelse(stateno=1001,time >= 9, time>= 12); && enemy,movetype != H)
...
triggerall = command != "holddown"
triggerall = Numhelper(2990) >= 1
triggerall = stateno != 8201 && stateno != 8710
triggerall = stateno != 8430
triggerall = stateno != [1030,1040]
trigger1 = statetype = S
trigger2 = hitdefattr = SC, NA, SA
